...
import './style.css';
import { generatePublicImg, generatePublicUrl } from '../../urlConfig';
        ...
        <div className="flexRow">
          <div className="verticalImageStack">
            {
              ...
              <div className="thumbnail">
                <img src={generatePublicImg(thumb.img)} alt={thumb.img} />
              </div>
              )
            }
          ...
          <div className="productDescContainer">
            <div className="productDescImgContainer">
              <img src={generatePublicImg(product.productDetails.productPictures[0].img)} alt={`${product.productDetails.productPictures[0].img}`} />
            </div>
